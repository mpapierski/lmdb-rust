...
use lmdb_rust::mdb::{
    ...
    mdb_env_set_maxreaders, mdb_env_stat, mdb_mode_t, mdb_put, mdb_size_t, mdb_txn_abort,
    mdb_txn_begin, mdb_txn_commit, MDB_cursor, MDB_dbi, MDB_env, MDB_stat, MDB_txn, MDB_val,
...
unsafe fn main_0(_argc: libc::c_int, _argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    let mut sval: [libc::c_char; 32] = Default::default();
