...
unsafe fn main_0(
    ...
    if rc == 0 as libc::c_int {} else {
        fprintf(
            ...
            b"mtest4.c\0" as *const u8 as *const libc::c_char,
            50 as libc::c_int,
    ...
    rc = mdb_dbi_open(
        ...
        (0x40000 as libc::c_int | 0x4 as libc::c_int | 0x10 as libc::c_int)
            as libc::c_uint,
        &mut dbi,
    );
    if rc == 0 as libc::c_int {} else {
    ...
    strcpy(kval.as_mut_ptr(), b"001\0" as *const u8 as *const libc::c_char);
    i = 0 as libc::c_int;
    while i < count {
        sprintf(
            sval.as_mut_ptr(),
        ...
        rc = mdb_put(txn, dbi, &mut key, &mut data, 0x20 as libc::c_int as libc::c_uint);
            ...
            || {
                if rc == 0 {} else {
                    fprintf(
                        ...
                        b"mtest4.c\0" as *const u8 as *const libc::c_char,
                        135 as libc::c_int,
                        b"mdb_del(txn, dbi, &key, &data)\0" as *const u8
                            as *const libc::c_char,
                        mdb_strerror(rc),
                    );
                    abort();
